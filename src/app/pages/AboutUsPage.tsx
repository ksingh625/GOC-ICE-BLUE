    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <section className="py-12 px-6 max-w-6xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((s, i) => (
            <div key={i} className="p-6 rounded-3xl border border-neutral-100 bg-neutral-50/50 text-center shadow-sm">
              <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center border border-neutral-100 mx-auto mb-4">
                {s.icon}
              </div>
              <p className="font-heading text-3xl font-black text-black mb-1">{s.val}</p>
      ...
      <section className="py-20 px-6 max-w-5xl mx-auto border-t border-neutral-100 mt-12 text-left">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="p-6 rounded-3xl border border-neutral-150 shadow-sm space-y-4">
              <div className="p-3 rounded-3xl bg-neutral-50 border border-neutral-100 w-fit">{v.icon}</div>
      ...
      <section className="py-20 px-6 max-w-5xl mx-auto border-t border-neutral-100 text-left">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-black">Meet GOC Builders</h2>
          <p className="text-xs text-neutral-500 mt-2">The team engineering the future of gamified marketing</p>
        </div>

        <div className="grid md:grid-cols-3 gap-6">
          {team.map((t, idx) => (
            <div key={idx} className="p-6 rounded-3xl border border-neutral-100 bg-[#fafafa] flex flex-col justify-between shadow-sm">
              <div>
                ...
                <h3 className="text-base font-extrabold text-black">{t.name}</h3>
