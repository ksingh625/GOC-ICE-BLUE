    ...
    <div className="min-h-screen bg-white text-black text-left">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-28 pb-16 grid md:grid-cols-4 gap-12">
        ...
        <div className="md:col-span-3 space-y-10">
          <div>
            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight mb-2" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>Terms of Service</h1>
          ...
          <section id="acceptance" className="space-y-3">
            <h2 className="text-lg font-extrabold text-black border-b border-neutral-100 pb-2" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>1. Acceptance of Terms</h2>
          ...
          <section id="account" className="space-y-3">
            <h2 className="text-lg font-extrabold text-black border-b border-neutral-100 pb-2" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>2. Account Registration</h2>
            <p className="text-xs text-neutral-600 leading-relaxed font-medium">
          ...
          <section id="contests" className="space-y-3">
            <h2 className="text-lg font-extrabold text-black border-b border-neutral-100 pb-2" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>3. Contest Campaigns</h2>
            <p className="text-xs text-neutral-600 leading-relaxed font-medium">
          ...
          <section id="payments" className="space-y-3">
            <h2 className="text-lg font-extrabold text-black border-b border-neutral-100 pb-2" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>4. Payments & Escrow</h2>
            <p className="text-xs text-neutral-600 leading-relaxed font-medium">
          ...
          <section id="liability" className="space-y-3">
            <h2 className="text-lg font-extrabold text-black border-b border-neutral-100 pb-2" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>5. Limitation of Liability</h2>
            <p className="text-xs text-neutral-600 leading-relaxed font-medium">
