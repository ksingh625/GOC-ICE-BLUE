...
export default function BrandDashboardPage() {
  return (
    <div className="p-6 md:p-10 max-w-7xl mx-auto space-y-8 animate-fade-in font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-[0_4px_16px_rgba(0,0,0,0.02)] flex items-start justify-between">
          <div>
            ...
            <p className="text-xs text-neutral-500 font-medium">Money spent on campaigns</p>
          </div>
        ...
        <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-[0_4px_16px_rgba(0,0,0,0.02)] flex items-start justify-between">
          <div>
            ...
            <p className="text-xs text-neutral-500 font-medium">Campaigns created</p>
          </div>
          <div className="w-10 h-10 rounded-full bg-neutral-100 flex items-center justify-center text-black border border-black/5">
            <Trophy size={18} />
          </div>
        ...
        <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-[0_4px_16px_rgba(0,0,0,0.02)] flex items-start justify-between">
          <div>
            ...
            <h3 className="text-2xl font-extrabold text-black mb-1">0</h3>
            <p className="text-xs text-neutral-500 font-medium">Views on campaign content</p>
          </div>
          <div className="w-10 h-10 rounded-full bg-neutral-100 flex items-center justify-center text-black border border-black/5">
            <Eye size={18} />
          </div>
        ...
        <div className="bg-white p-5 rounded-3xl border border-black/5 shadow-[0_4px_16px_rgba(0,0,0,0.02)] flex items-start justify-between">
          <div>
            ...
            <p className="text-xs text-neutral-500 font-medium">Coins to redeem or use</p>
          </div>
      ...
      {/* Onboarding Banner */}
      <div className="bg-white rounded-3xl border border-black/5 shadow-[0_4px_16px_rgba(0,0,0,0.02)] p-4 md:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-start sm:items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-500 font-medium mt-0.5">Learn about our two campaign types: Leaderboard and CPM campaigns</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-3xl border border-black/5 shadow-[0_4px_16px_rgba(0,0,0,0.02)] overflow-hidden flex flex-col min-h-[300px]">
          <div className="p-6 border-b border-black/5">
            ...
            <p className="text-sm text-neutral-500 font-medium">Your recent campaigns</p>
          </div>
        ...
        <div className="bg-white rounded-3xl border border-black/5 shadow-[0_4px_16px_rgba(0,0,0,0.02)] overflow-hidden flex flex-col min-h-[300px]">
          <div className="p-6 border-b border-black/5">
            ...
            <p className="text-sm text-neutral-500 font-medium">Performance insights for your campaigns</p>
          </div>
