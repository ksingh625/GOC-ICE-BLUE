  ...
  if (view === "main") {
    return (
      <div className="p-6 md:p-8 max-w-5xl mx-auto">
        ...
        {/* Toast */}
        {toast && (
          <div className="fixed top-6 right-6 z-50 flex items-center gap-2.5 bg-black text-white text-xs font-bold px-4 py-3 rounded-2xl shadow-xl animate-fade-in border border-white/10">
        ...
        <div className="mb-8 flex items-center justify-between">
          ...
          <button
            ...
            className="btn-primary-gradient flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-black shadow-sm"
          >
            <User size={13} />
            Edit Profile
          </button>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-52 flex-shrink-0">
            <nav className="bg-white border border-neutral-200/60 rounded-2xl p-2 space-y-0.5 sticky top-4">
              {navSections.map(s => (
                <button
                  key={s.id}
              ...
              <div className="pt-2 border-t border-neutral-100 mt-2">
                <button
                  onClick={() => navigate("/")}
                  className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-bold text-red-500 hover:bg-red-50 transition-all text-left cursor-pointer"
                >
                  <Trash2 size={14} />
                  Log Out
                </button>
          ...
          <div className="flex-1 space-y-5">
            ...
            <div className="bg-white border border-neutral-200/60 rounded-3xl p-5 flex items-center gap-5">
              <div className="w-14 h-14 rounded-2xl bg-black text-[#d1f8ff] flex items-center justify-center font-black text-xl shadow-md flex-shrink-0">
                {avatarLetter}
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="text-sm font-black text-black" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>{name}</h3>
            ...
            {activeSection === "socials" && (
              <div className="bg-white border border-neutral-200/60 rounded-3xl p-6 space-y-4">
                <div className="mb-2">
                  <h2 className="text-sm font-black text-black" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>Social Accounts</h2>
                  <p className="text-[11px] text-neutral-500 mt-0.5">Connect your channels to participate in campaigns and verify views.</p>
                </div>

                {socials.map((s) => (
                  <div key={s.id} className={`flex items-center justify-between p-4 rounded-2xl border transition-all ${s.connected ? "border-black bg-black/[0.02]" : "border-neutral-200"}`}>
                    <div className="flex items-center gap-3.5">
                      <div className={`w-10 h-10 rounded-xl ${s.iconBg} ${s.iconColor} flex items-center justify-center flex-shrink-0 border border-neutral-200/60`}>
                        {s.icon}
                      </div>
                      <div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white border border-neutral-200/60 rounded-3xl p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h2 className="text-sm font-black text-black" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>Profile Completion</h2>
                  ...
                  <button
                    onClick={() => setView("profile")}
                    className="btn-primary-gradient px-4 py-2.5 rounded-xl text-xs font-black"
                  >
                    Complete Profile
                  </button>
                </div>
                ...
                <div className="bg-white border border-neutral-200/60 rounded-3xl p-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h2 className="text-sm font-black text-black" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>Referral Program</h2>
                  </div>
                  ...
                  <div className="flex items-center gap-2 bg-neutral-50 border border-neutral-200 rounded-xl px-4 py-3">
                    ...
                    <button
                      onClick={copyRef}
                      className="flex items-center gap-1.5 bg-black text-white px-3 py-1.5 rounded-lg text-[10px] font-bold hover:bg-neutral-800 transition-colors cursor-pointer flex-shrink-0"
                    >
            ...
            {activeSection === "notifications" && (
              <div className="bg-white border border-neutral-200/60 rounded-3xl p-6 space-y-4">
                <h2 className="text-sm font-black text-black mb-2" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>Notification Preferences</h2>
                ...
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-4 bg-neutral-50/50 border border-neutral-100 rounded-2xl">
                    <div>
            ...
            {activeSection === "security" && (
              <div className="space-y-4">
                    ...
                    <div className="mt-5 pt-4 border-t border-neutral-100 space-y-3 max-w-sm">
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-4 py-2.5 border border-neutral-200 rounded-xl text-xs focus:outline-none focus:border-black bg-neutral-50/30 pr-10"
                        />
                        <button
                          type="button"
                      ...
                      <input type="password" placeholder="New password" className="w-full px-4 py-2.5 border border-neutral-200 rounded-xl text-xs focus:outline-none focus:border-black bg-neutral-50/30" />
                      <input type="password" placeholder="Confirm new password" className="w-full px-4 py-2.5 border border-neutral-200 rounded-xl text-xs focus:outline-none focus:border-black bg-neutral-50/30" />
                      <button
                        onClick={() => { showToast("Password updated!"); setPwdOpen(false); }}
                        className="bg-black text-white px-5 py-2.5 rounded-xl text-xs font-black hover:bg-neutral-800 transition-colors cursor-pointer"
                      >
                        Update Password
                      </button>
                    </div>
                ...
                {/* Active Sessions */}
                <div className="bg-white border border-neutral-200/60 rounded-3xl p-6">
                  <h2 className="text-sm font-black text-black mb-4" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>Active Sessions</h2>
                  <div className="space-y-2">
                    {[
                      ...
                      <div key={i} className={`flex items-center gap-3 p-3.5 rounded-2xl border ${sess.active ? "border-black bg-black/[0.02]" : "border-neutral-200"}`}>
                        <div className={`w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 ${sess.active ? "bg-black text-white" : "bg-neutral-100 text-neutral-500"}`}>
                          {sess.icon}
                        </div>
                        <div className="flex-1 min-w-0">
                  ...
                  <button
                    ...
                    className="mt-4 px-4 py-2.5 bg-red-50 text-red-500 hover:bg-red-100 border border-red-100 rounded-xl text-xs font-bold transition-colors cursor-pointer"
                  >
                ...
                <div className="bg-white border border-red-200/60 rounded-3xl p-6">
                  ...
                  <button className="px-4 py-2.5 border border-red-300 text-red-500 hover:bg-red-500 hover:text-white rounded-xl text-xs font-black transition-all cursor-pointer">
                    Delete Account
                  </button>
                </div>
              </div>
            ...
            {activeSection === "community" && (
              <div className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={i} className={`${c.bg} border border-neutral-200/60 rounded-3xl p-6`}>
                      <div className="w-10 h-10 rounded-2xl bg-white border border-neutral-200 flex items-center justify-center mb-4 shadow-sm text-black">
                        {c.icon}
                      </div>
                      <h3 className="text-sm font-black text-black" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>{c.name}</h3>
                      <p className="text-[11px] text-neutral-500 mt-1.5 mb-4 leading-relaxed">{c.desc}</p>
                      <a
                        href={c.href}
                        target="_blank"
                        rel="noreferrer"
                        className={`inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-xs font-black transition-colors ${c.btnColor}`}
                      >
                ...
                <div className="bg-white border border-neutral-200/60 rounded-3xl p-6">
                  <h3 className="text-sm font-black text-black mb-4" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>Need Help?</h3>
                  ...
                  <a href="tel:+919876543210" className="inline-flex items-center gap-2 bg-black text-white px-5 py-2.5 rounded-xl text-xs font-black hover:bg-neutral-800 transition-colors">
    ...
    <div className="p-6 md:p-8 max-w-3xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-8">
        <button
          ...
          className="w-9 h-9 rounded-xl border border-neutral-200 hover:bg-neutral-50 flex items-center justify-center text-neutral-500 hover:text-black transition-colors cursor-pointer"
        >
          <ArrowLeft size={15} />
        </button>
        <div>
          <h1 className="text-xl font-black text-black" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>
            Edit Profile
          </h1>
      ...
      {/* Trust score banner */}
      <div className="bg-emerald-50 border border-emerald-100 rounded-2xl px-5 py-4 flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
      ...
      <form onSubmit={handleSave} className="space-y-5">
        ...
        <div className="bg-white border border-neutral-200/60 rounded-3xl p-6 flex items-center gap-5">
          <div className="w-16 h-16 rounded-2xl bg-black text-[#d1f8ff] flex items-center justify-center font-black text-2xl shadow-lg flex-shrink-0">
            {avatarLetter}
          </div>
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-[9px] font-black uppercase tracking-widest text-neutral-400 mb-1.5">Username</label>
              <div className="px-4 py-2.5 bg-neutral-100 border border-neutral-200 rounded-xl text-xs font-semibold text-neutral-500">
                {handle.replace("@", "")}
              </div>
            </div>
            <div>
        ...
        {/* Personal info */}
        <div className="bg-white border border-neutral-200/60 rounded-3xl p-6 space-y-4">
          <h3 className="text-sm font-black text-black" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>Personal Details</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-neutral-200 rounded-xl text-xs focus:outline-none focus:border-black transition-colors"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-neutral-200 rounded-xl text-xs focus:outline-none focus:border-black"
              />
            </div>
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2.5 border border-neutral-200 rounded-xl text-xs focus:outline-none focus:border-black bg-white"
              >
                <option>Male</option>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2.5 border border-neutral-200 rounded-xl text-xs focus:outline-none focus:border-black resize-none"
            />
          </div>
        </div>
        ...
        {/* Niche tags */}
        <div className="bg-white border border-neutral-200/60 rounded-3xl p-6">
          <h3 className="text-sm font-black text-black mb-1" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>Content Niches</h3>
        ...
        <button
          type="submit"
          className="w-full btn-primary-gradient py-4 rounded-2xl text-sm font-black shadow-sm hover:opacity-90 transition-opacity"
        >
